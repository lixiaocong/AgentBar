#!/bin/bash
# build-app.sh — Builds AgentBar.app with the embedded widget extension and installs it.
# Usage: ./scripts/build-app.sh
# Output: build/AgentBar.app and /Applications/AgentBar.app
...
XCODEPROJ="$PROJECT_DIR/AgentBar.xcodeproj"
ICON_SCRIPT="$PROJECT_DIR/scripts/generate-icons.swift"
ICON_FILE="$PROJECT_DIR/Resources/AppIcon.icns"
APP_ENTITLEMENTS="$PROJECT_DIR/Resources/AgentBar.entitlements"
WIDGET_ENTITLEMENTS="$PROJECT_DIR/Resources/AgentBarWidget.entitlements"
